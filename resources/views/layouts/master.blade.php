              ...
              <!-- Header Navbar: style can be found in header.less -->
                ...
                <div class="navbar-custom-menu">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <li>
                            ...
                            <li><!-- start message -->
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('public/asset/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image"/>
                                </div>
                                <h4>
                                    Support Team
                            ...
                            <li>
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('public/asset/img/user3-128x128.jpg')}}" class="img-circle" alt="user image"/>
                                </div>
                                <h4>
                            ...
                            <li>
                                <a href="#">
                                <div class="pull-left">
                                    <img src="{{asset('public/asset/img/user4-128x128.jpg')}}" class="img-circle" alt="user image"/>
                                </div>
                                <h4>
                                    Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{asset('public/asset/img/user2-160x160.jpg')}}" class="user-image" alt="User Image"/>
            ...
            <section class="sidebar">
              ...
              <div class="user-panel">
                <div class="pull-left image">
                  <img src="{{('public/asset/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image" />
                </div>
              ...
              <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                  ...
                  <ul class="treeview-menu">
                    <li class="active"><a href="{{url('admin/all_blog')}}"><i class="fa fa-circle-o"></i>Show All Blogs</a></li>
                    <li class="active"><a href="{{url('admin/all_user')}}"><i class="fa fa-circle-o"></i>Show All User</a></li>
                    <li class="active"><a href="{{url('admin/')}}"><i class="fa fa-circle-o"></i>Admin</a></li>
